    ...
    >
      ...
      <Grid item>
        <Autocomplete
          ...
          renderInput={(params) => <TextField {...params} label="Entrevista terapêutica" variant="outlined" />}
        />
      </Grid>
      <Grid item>
        <Autocomplete
          ...
          options={lopicle}
          getOptionLabel={(option) => option.title}
          renderInput={(params) => <TextField {...params} label="Lopículo" variant="outlined" />}
        />
      </Grid>
